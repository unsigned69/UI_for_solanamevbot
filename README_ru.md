...
`smb-ui` — локальный Next.js интерфейс для оператора Solana MEV бота (https://docs.solanamevbot.com/home/). Приложение помогает вручную подбирать токены, управлять конфигурацией и контролировать запуск процесса без вмешательства в приватные ключи.
